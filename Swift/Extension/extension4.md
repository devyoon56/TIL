...
1. 값타입이 자동으로 기본 생성자와 멤버와이즈 생성자를 제공받는 경우
...
2. 값타입이 자동으로 기본 생성자와 멤버와이즈 생성자를 제공받지 않는 경우
...
직사각형을 나타내는 Rect 구조체를 정의하는 예제입니다. 또한 모든 저장 속성에 기본값을 할당하고 있는 Size, Point 구조체를 정의하여 Rect 구조체를 지원하고 있습니다.
...
// 멤버와이즈 생성자를 사용하여 인스턴스 생성 (origin, size 속성도 멤버와이즈 생성자 사용하여 인스턴스 생성)
let memberwiseRect = Rect(origin: Point(x: 2.0, y: 2.0), size: Size(width: 5.0, height: 5.0))

// 멤버와이즈 생성자를 사용하여 인스턴스 생성 (origin, size 속성은 기본 생성자 사용하여 인스턴스 생성)
