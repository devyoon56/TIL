...
AnyObject 타입은 어떠한 클래스의 인스턴스를 표현할 수 있는 타입입니다. 하지만 구조체의 인스턴스를 표현하지는 못합니다.
...
switch문에서 상수 바인딩 시 다운캐스팅 연산자 as? 를 사용하지 않고 as를 사용하는 이유는 다운캐스팅이 성공하는 경우에만 상수 바인딩이 되기 때문에 switch문에서는 ? 를 생략할 수 있습니다.
