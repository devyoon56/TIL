...
- 인스턴스가 타입이면 true를 반환합니다.
- 인스턴스가 타입이 아니면 false를 반환합니다.
...
- Undergraduate 타입의 인스턴스는 Person, Student 타입이 될 수 있습니다. 왜냐하면 Undergraduate 타입이 Person, Student 타입을 포함하기 때문입니다.
