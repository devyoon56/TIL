...
- 인스턴스가 타입에 속하면 true를 반환합니다.
- 인스턴스가 타입에 속하지 않으면 false를 반환합니다.
...
- Person 타입의 인스턴스는 Person 타입이 Student, Undergraduate 타입에 포함되므로 Student, Undergraduate 타입이 아닙니다.
- Student 타입의 인스턴스는 Student 타입이 Undergraduate 타입에 포함되므로 Undergraduate 타입이 아닙니다.
  - 하지만 Student 타입이 Person 타입을 포함하므로 Person 타입이 될 수 있습니다.
- Undergraduate 타입의 인스턴스는 Person, Student 타입을 포함하므로 Person, Student 타입이 될 수 있습니다.
...
- under1, under2는 Undergraduate 타입의 인스턴스이지만 Student 타입이 될 수 있습니다.
