...
시퀀스(수치 범위, 문자열, 컬렉션 타입)에서 item을 하나씩 뽑아서 for-in 반복문 안에서 반복 실행합니다.
...
for-in 반복문의 중괄호 내부에서 선언한 변수나 상수는 중괄호 밖에서 접근할 수 없습니다.
하지만 for-in 반복문의 중괄호 내부에서는 중괄호 외부의 변수나 상수에 접근할 수 있습니다.
